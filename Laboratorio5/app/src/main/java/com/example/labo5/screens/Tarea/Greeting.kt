package com.example.labo5.screens.Tarea
...
import com.example.labo5.GeneralViewModel
import com.example.labo5.components.TaskCard
...
fun Greeting(viewModel: GeneralViewModel = viewModel(),
    ...
    Scaffold(
        ...
        LazyColumn(modifier = Modifier.padding(paddingValues)) {
            ...
            item{
                Button(onClick =   navegationBackHome) {
